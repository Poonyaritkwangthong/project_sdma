                ...
                <div class="flex items-center gap-2">
                    <div>
                        ...
                        <input type="text"
                            ...
                            id="receive_detail_internal" name="receive_detail" placeholder="โปรดระบุแผนก" disabled>
                    </div>
                    <div>
                        ...
                        <input class="text-[#525456] text-lg bg-[#f4f4fc] border-[#a3a0df] p-1 rounded-lg"
                            type="date" id="admit_date" name="admit_date">
                    </div>
                </div>
            </div>
        </div>
        <div class="flex gap-6 items-center">
            ...
            <div id="externalField" style="display: none;">
                ...
                <input class="text-[#525456] text-lg bg-[#f4f4fc] border-[#a3a0df] p-1 rounded-lg" type="text"
                    id="receive_detail_external" name="receive_detail" placeholder="โปรดระบุหน่วยงานภายนอก" disabled>
            </div>
        </div>
    </div>
</div>
...
<div class="pl-6 mb-[2rem]">
    ...
    <div class="mt-[1rem]">
        ...
        <div class="pl-[6rem]">
            ...
            <label class="text-[#525456] text-lg" for="source_of_income">จากการทำงาน</label>
        </div>
        <div class="flex gap-2 items-center pl-[6rem]">
            ...
            <label class="text-[#525456] text-lg" for="source_of_income">จากผู้อื่น</label>
            <div id="on-4" style="display: none;">
                <label class="text-[#525456] text-lg" for="source_of_income_detail">ระบุ</label>
                <input class="text-[#525456] text-lg bg-[#f4f4fc] border-[#a3a0df] p-1 rounded-lg" type="text"
                    value="" name="source_of_income_detail" id="">
            </div>
        </div>
    </div>
        ...
        <div class="flex items-center gap-4 pl-10 mt-[1rem]">
            ...
            <div class="flex gap-2 items-center">
                <div>
                    ...
                    <label class="text-[#525456] text-lg" for="having_debt">มี</label>
                </div>
                    ...
                    <div class="flex gap-2 items-center">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <label class="text-[#525456] text-lg" for="source_of_debt">ในระบบ</label>
                            </div>
                            <div>
                                <input type="radio" value="นอกระบบ" name="source_of_debt" id="">
                                <label class="text-[#525456] text-lg" for="source_of_debt">นอกระบบ</label>
                            </div>
                        </div>
                    </div>
