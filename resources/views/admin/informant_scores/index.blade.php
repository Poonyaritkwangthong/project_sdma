            ...
            <table class="w-full">
                <thead>
                    <tr class="text-center text-[#7d8a99] text-sm border-b">
                        ...
                        <th class="p-2 pb-4">คะเเนน</th>
                        <th class="p-2 pb-4">เกณฑ์</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($informants as $item)
                        <tr class="text-[#7d8a99] border-b text-center">
                            ...
                            <td class="p-4">{{ $item->total_score }}</td>
                            <td class="p-4">
                                @if ($item->total_score <= 20)
                                    <h1 class="text-red-700">ระดับความพร้อมน้อย</h1>
                                @elseif ($item->total_score <= 30)
                                    <h1 class="text-yellow-600">ระดับความพร้อมปลานกลาง</h1>
                                @elseif ($item->total_score <= 40)
                                    <h1 class="text-green-500">ระดับความพร้อมมาก</h1>
                                @elseif ($item->total_score <= 47)
                                    <h1 class="text-blue-600">ระดับความพร้อมมากที่สุด</h1>
                                @endif
                            </td>
                        </tr>
                    @endforeach
